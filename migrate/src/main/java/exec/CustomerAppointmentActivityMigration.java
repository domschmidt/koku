...
public class CustomerAppointmentActivityMigration extends BaseMigration {
    ...
    public void migrate() throws Exception {
        ...
        read(
                "SELECT id, external_ref FROM koku.activity",
                rs -> {
                    try {
        ...
        read(
                "SELECT id, recorded, updated, position, sell_price, activity_id, customer_appointment_id"
                        + " FROM koku.customer_appointment_activities_composing",
                rs -> {
                    try {
