...
public class CustomerAppointmentActivitySequenceMigration extends BaseMigration {
    ...
    public CustomerAppointmentActivitySequenceMigration(Connection source, Connection target, Connection activityStepTarget, Connection productTarget) {
        super(source, target);
    ...
    public void migrate() throws Exception {
        ...
        read("SELECT id, external_ref FROM koku.activity_step", rs -> {
            try {
        ...
        read("SELECT id, recorded, updated, customer_appointment_id, optional_activity_step_id, optional_product_id, position FROM koku.activity_sequence_item", rs -> {
            try {
