...
public final class DavPropertyNames {
    ...
    public static final DavPropertyName ADDRESSBOOK =
            new DavPropertyName(DAVConstants.CARDDAV_NAMESPACE, DAVConstants.CARD_RESOURCE_ADDRESSBOOK);
    ...
    public static final DavPropertyName COLLECTION =
            new DavPropertyName(DAVConstants.DAV_NAMESPACE, DAVConstants.DAV_RESOURCE_COLLECTION);
    ...
    public static final DavPropertyName PRINCIPAL =
            new DavPropertyName(DAVConstants.DAV_NAMESPACE, DAVConstants.DAV_RESOURCE_PRINCIPAL);
    public static final DavPropertyName READ_PRIVILEGE =
            new DavPropertyName(DAVConstants.DAV_NAMESPACE, DAVConstants.DAV_PRIVILEGE_READ);
    ...
    public static final DavPropertyName SYNC_COLLECTION =
            new DavPropertyName(DAVConstants.DAV_NAMESPACE, DAVConstants.DAV_REPORT_SYNC_COLLECTION);
    ...
    public static final DavPropertyName ADDRESSBOOK_MULTIGET =
            new DavPropertyName(DAVConstants.CARDDAV_NAMESPACE, DAVConstants.CARD_REPORT_ADDRESSBOOK_MULTIGET);
    public static final DavPropertyName ADDRESSBOOK_QUERY =
            new DavPropertyName(DAVConstants.CARDDAV_NAMESPACE, DAVConstants.CARD_REPORT_ADDRESSBOOK_QUERY);
    public static final DavPropertyName CALENDAR =
            new DavPropertyName(DAVConstants.CALDAV_NAMESPACE, DAVConstants.CALDAV_RESOURCE_CALENDAR);
    ...
    public static final DavPropertyName CALENDAR_MULTIGET =
            new DavPropertyName(DAVConstants.CALDAV_NAMESPACE, DAVConstants.CALDAV_REPORT_CALENDAR_MULTIGET);
    public static final DavPropertyName CALENDAR_QUERY =
            new DavPropertyName(DAVConstants.CALDAV_NAMESPACE, DAVConstants.CALDAV_REPORT_CALENDAR_QUERY);
    public static final DavPropertyName VEVENT =
            new DavPropertyName(DAVConstants.CALDAV_NAMESPACE, DAVConstants.CALDAV_COMPONENT_VEVENT);
