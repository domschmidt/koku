...
import {
  MultiSelectWithPricesFieldComponent
} from '../fields/multi-select-with-prices/multi-select-with-prices-field.component';
...
const CONTAINER_REGISTRY: Partial<Record<KokuDto.AbstractFormContainer["@type"], {
  componentType: any;
      ...
      for (const currentContent of castedFormularContent.content || []) {
        if (currentContent['@type']) {
          ...
          if (mappedFieldConfig) {
            const fieldContentStates = mappedFieldConfig.stateInitializer(currentContent as KokuDto.AbstractFormField<any>);
          ...
          const mappedContainerConfig = CONTAINER_REGISTRY[currentContent['@type'] as KokuDto.AbstractFormContainer['@type']];
          if (mappedContainerConfig) {
            const containerContentStates = mappedContainerConfig.stateInitializer(currentContent as KokuDto.AbstractFormContainer);
...
const FIELD_REGISTRY: Partial<Record<KokuDto.AbstractFormField<any>["@type"], {
  componentType: any;
  stateInitializer: (formularContent: KokuDto.AbstractFormField<any>) => FormularContentStates,
  inputBindings?(instance: FieldRendererComponent, formularContent: KokuDto.AbstractFormField<any>): {
    [key: string]: any
  }
  outputBindings?(instance: FieldRendererComponent, formularContent: KokuDto.AbstractFormField<any>): {
    [key: string]: any
  }
}
>> = {
  "picture-upload": {
    ...
    inputBindings(instance: FieldRendererComponent, formularContent: KokuDto.PictureUploadFormularField): {
      [p: string]: any
    } {
      return {
    ...
    outputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.PictureUploadFormularField) => {
      return {
  ...
  "input": {
    ...
    outputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.InputFormularField) => {
      return {
        onChange: (data: any) => instance.emitToFieldEventBus('onChange', data),
  ...
  "select": {
    ...
    outputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.SelectFormularField) => {
      return {
        onChange: (data: any) => instance.emitToFieldEventBus('onChange', data),
        onBlur: (data: any) => instance.emitToFieldEventBus('onBlur', data),
        onFocus: (data: any) => instance.emitToFieldEventBus('onFocus', data),
  ...
  "multi-select-with-pricing-adjustment": {
    ...
    stateInitializer: FIELD_INITIALIZER,
    inputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.MultiSelectWithPricingAdjustmentFormularField) => {
      return {
        ...(formularContent.label && {label: formularContent.label}),
        ...(formularContent.placeholder && {placeholder: formularContent.placeholder}),
        ...(formularContent.defaultValue && {defaultValue: formularContent.defaultValue}),
    ...
    outputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.MultiSelectWithPricingAdjustmentFormularField) => {
      return {
        onChange: (data: any) => instance.emitToFieldEventBus('onChange', data),
        onBlur: (data: any) => instance.emitToFieldEventBus('onBlur', data),
        onFocus: (data: any) => instance.emitToFieldEventBus('onFocus', data),
  ...
  "multi-select": {
    ...
    outputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.MultiSelectFormularField) => {
      return {
        onChange: (data: any) => instance.emitToFieldEventBus('onChange', data),
        onBlur: (data: any) => instance.emitToFieldEventBus('onBlur', data),
        onFocus: (data: any) => instance.emitToFieldEventBus('onFocus', data),
  ...
  "document-designer": {
    ...
    outputBindings: (instance: FieldRendererComponent, formularContent: KokuDto.DocumentDesignerFormularField) => {
      return {
        onChange: (data: any) => instance.emitToFieldEventBus('onChange', data),
        onBlur: (data: any) => instance.emitToFieldEventBus('onBlur', data),
        onFocus: (data: any) => instance.emitToFieldEventBus('onFocus', data),
...
const BUTTON_REGISTRY: Partial<Record<KokuDto.KokuFormButton["@type"], {
  componentType: any;
  stateInitializer: (formularContent: KokuDto.KokuFormButton) => FormularContentStates,
  inputBindings?(instance: ButtonRendererComponent, formularContent: KokuDto.KokuFormButton): { [key: string]: any }
  outputBindings?(instance: ButtonRendererComponent, formularContent: KokuDto.KokuFormButton): {
    [key: string]: any
  }
}>> = {
  "button": {
    ...
    inputBindings: (instance: ButtonRendererComponent, formularContent: KokuDto.KokuFormButton) => {
      ...
      if (instance.enableDockedOutput()) {
        res = {
          ...
          ...((formularContent.dockableSettings || {}).title && {title: (formularContent.dockableSettings || {}).title}),
          ...((formularContent.dockableSettings || {}).styles && {styles: (formularContent.dockableSettings || {}).styles}),
...
const FIELD_SLOT_REGISTRY: Partial<Record<KokuDto.IFormFieldSlot["@type"], {
  componentType: any;
  inputBindings?(instance: FieldSlotRendererComponent, formularContent: KokuDto.IFormFieldSlot): { [key: string]: any }
  outputBindings?(instance: FieldSlotRendererComponent, formularContent: KokuDto.IFormFieldSlot): {
    [key: string]: any
  }
}>> = {
  "button": {
...
const LAYOUT_REGISTRY: Partial<Record<KokuDto.AbstractFormLayout["@type"], {
  componentType: any;
  stateInitializer: (formularContent: KokuDto.AbstractFormLayout) => FormularContentStates,
  inputBindings?(instance: LayoutRendererComponent, formularContent: KokuDto.AbstractFormLayout): { [key: string]: any }
  outputBindings?(instance: LayoutRendererComponent, formularContent: KokuDto.AbstractFormLayout): {
    [key: string]: any
  }
}>> = {
  "divider": {
