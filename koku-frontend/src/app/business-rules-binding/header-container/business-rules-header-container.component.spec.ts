...
import { BusinessRulesHeaderContainerComponent } from './business-rules-header-container.component';

describe('BusinessRulesHeaderContainerComponent', () => {
  it('loads and updates titles and emits close commands', async () => {
    const http = { get: vi.fn(() => of({ customer: { name: 'Before' } })) };
    await TestBed.configureTestingModule({
      imports: [BusinessRulesHeaderContainerComponent],
      providers: [{ provide: HttpClient, useValue: http }],
    })
      .overrideComponent(BusinessRulesHeaderContainerComponent, { set: { template: '' } })
      .compileComponents();
    const fixture = TestBed.createComponent(BusinessRulesHeaderContainerComponent);
    ...
    fixture.componentRef.setInput('content', {
      globalEventListeners: [
        { '@type': 'event-payload', eventName: 'rule-header-update', idPath: 'id', titleValuePath: 'customer.name' },
      ],
    });
    fixture.detectChanges();
    const component = fixture.componentInstance;
    expect(component.loadedTitle()).toBe('Before');
    GLOBAL_EVENT_BUS.propagateGlobalEvent('rule-header-update', { id: 42, customer: { name: 'After' } });
