...
import { BusinessRulesDockContainerComponent } from './business-rules-dock-container.component';

describe('BusinessRulesDockContainerComponent', () => {
  it('loads titles, follows routed tabs, emits commands and handles empty content', async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [BusinessRulesDockContainerComponent],
      providers: [
        { provide: Router, useValue: router },
        { provide: HttpClient, useValue: http },
      ],
    })
      .overrideComponent(BusinessRulesDockContainerComponent, { set: { template: '' } })
      .compileComponents();
    const fixture = TestBed.createComponent(BusinessRulesDockContainerComponent);
