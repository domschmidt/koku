...
import { ListDockContainerComponent } from './list-dock-container.component';

describe('ListDockContainerComponent', () => {
  it('loads titles, follows routed tabs, emits commands and handles empty content', async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ListDockContainerComponent],
      providers: [
        { provide: Router, useValue: router },
        { provide: HttpClient, useValue: http },
      ],
    })
      .overrideComponent(ListDockContainerComponent, { set: { template: '' } })
      .compileComponents();
    const fixture = TestBed.createComponent(ListDockContainerComponent);
    ...
    expect(router.navigate).toHaveBeenCalledWith(['', 'base', 'details', '42']);
