...
const CONTAINER_REGISTRY: Partial<Record<KokuDto.AbstractDashboardContainer["@type"], {
  componentType: any;
  inputBindings?(instance: any, content: KokuDto.AbstractDashboardContainer): { [key: string]: any }
  outputBindings?(instance: any, content: KokuDto.AbstractDashboardContainer): { [key: string]: any }
}
>> = {
  "grid": {
    componentType: DashboardGridContainerComponent,
    inputBindings(instance: any, content: KokuDto.DashboardGridContainerDto): { [p: string]: any } {
      return {
        'content': content,
...
const PANEL_REGISTRY: Partial<Record<KokuDto.AbstractDashboardPanel["@type"], {
  componentType: any;
  inputBindings?(instance: FieldRendererComponent, content: KokuDto.AbstractDashboardPanel): {
    [key: string]: any
  }
  outputBindings?(instance: FieldRendererComponent, content: KokuDto.AbstractDashboardPanel): {
    [key: string]: any
  }
}
>> = {
  "text": {
    ...
    inputBindings(instance: FieldRendererComponent, content: KokuDto.DashboardTextPanelDto): { [p: string]: any } {
      return {
        'content': content
      }
    },
  ...
  "appointments": {
    ...
    inputBindings(instance: FieldRendererComponent, content: KokuDto.DashboardAppointmentsPanelDto): { [p: string]: any } {
      return {
        'content': content
      }
    },
  ...
  "async-text": {
    ...
    inputBindings(instance: FieldRendererComponent, content: KokuDto.DashboardAsyncTextPanelDto): { [p: string]: any } {
      return {
        'content': content
      }
    },
  ...
  "async-chart": {
    ...
    inputBindings(instance: FieldRendererComponent, content: KokuDto.DashboardAsyncChartPanelDto): { [p: string]: any } {
      return {
