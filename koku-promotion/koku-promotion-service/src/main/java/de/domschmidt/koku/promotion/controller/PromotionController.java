...
public class PromotionController {
    ...
    public FormViewDto getFormularView() {
        ...
        final String deleteContainerId = formFactory.addContent(ConditionalContainer.builder()
                .compareValuePath(KokuPromotionDto.Fields.deleted)
    ...
    public ListViewDto getListView() {
        final ListViewFactory listViewFactory =
                new ListViewFactory(new DefaultListViewContentIdGenerator(), KokuPromotionDto.Fields.id);

        final ListViewSourcePathReference idSourcePathRef = listViewFactory.addSourcePath(KokuPromotionDto.Fields.id);
        final ListViewSourcePathReference deletedSourcePathRef =
                listViewFactory.addSourcePath(KokuPromotionDto.Fields.deleted);
