...
public class PromotionKafkaService {
    ...
    @Autowired
    public PromotionKafkaService(final KafkaTemplate<Long, PromotionKafkaDto> promotionKafkaTemplate) {
        this.promotionKafkaTemplate = promotionKafkaTemplate;
    }

    public SendResult<Long, PromotionKafkaDto> sendPromotion(final Promotion promotion)
            throws ExecutionException, InterruptedException, TimeoutException {
        return this.promotionKafkaTemplate
                .send(
