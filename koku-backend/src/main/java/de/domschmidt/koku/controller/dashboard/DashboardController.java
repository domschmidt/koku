    ...
    public IDashboardColumnContent getTotalRevenuePanel() {
        ...
        return DiagramDashboardColumnContent.builder()
                ...
                .overlay(ChartTextOverlay.builder()
                        .text(statisticsForCurrentMonth.getTotal() + " € (" + statisticsForCurrentMonth.getTotal().subtract(statisticsUntilToday.getTotal()) + " € offen)")
    ...
    public IDashboardColumnContent getProductRevenuePanel() {
        ...
        return DiagramDashboardColumnContent.builder()
                ...
                .options(ChartOptions.builder()
                        ...
                        .build())
                .overlay(ChartTextOverlay.builder()
                        .text(statisticsForCurrentMonth.getProducts() + " € (" + statisticsForCurrentMonth.getProducts().subtract(statisticsUntilToday.getProducts()) + " € offen)")
    ...
    public IDashboardColumnContent getActivityRevenuePanel() {
        ...
        return DiagramDashboardColumnContent.builder()
                ...
                .options(ChartOptions.builder()
                        ...
                        .build())
                .overlay(ChartTextOverlay.builder()
                        .text(statisticsForCurrentMonth.getActivities() + " € (" + statisticsForCurrentMonth.getActivities().subtract(statisticsUntilToday.getActivities()) + " € offen)")
