...
public class ActivityKafkaService {
    ...
    @Autowired
    public ActivityKafkaService(final KafkaTemplate<Long, ActivityKafkaDto> activityKafkaTemplate) {
        this.productKafkaTemplate = activityKafkaTemplate;
    }

    public SendResult<Long, ActivityKafkaDto> sendActivity(final Activity activity)
