...
public class ActivityStepKafkaService {
    ...
    @Autowired
    public ActivityStepKafkaService(final KafkaTemplate<Long, ActivityStepKafkaDto> activityStepKafkaTemplate) {
        this.activityStepKafkaTemplate = activityStepKafkaTemplate;
    }

    public SendResult<Long, ActivityStepKafkaDto> sendActivityStep(final ActivityStep activityStep)
            throws ExecutionException, InterruptedException, TimeoutException {
        return this.activityStepKafkaTemplate
                .send(
