...
public class UserController {
                ...
                .place(formFactory.addContent(SelectFormularField.builder()
                        ...
                        .possibleValues(new JPAQuery<>(this.entityManager, JPQLTemplates.DEFAULT)
                                .select(QUserRegion.userRegion).from(QUserRegion.userRegion).fetch().stream()
                                        .map(userRegion -> SelectFormularFieldPossibleValue.builder()
                                                .id(userRegion.getId() + "")
                                                .text(
    ...
    public ListViewDto getListView(@RequestParam(required = false) Optional<Boolean> selectMode) {
        ...
        final ListViewSourcePathReference idSourcePathRef = listViewFactory.addSourcePath(KokuUserDto.Fields.id);
        final ListViewSourcePathReference avatarSourcePathRef =
                listViewFactory.addSourcePath(KokuUserDto.Fields.avatarBase64);
        final ListViewFieldReference fullnameFieldRef = listViewFactory.addField(
                KokuUserDto.Fields.fullname, ListViewInputFieldDto.builder().build());
        final ListViewSourcePathReference deletedSourcePathRef =
                listViewFactory.addSourcePath(KokuUserDto.Fields.deleted);
        ...
        if (!selectMode.orElse(Boolean.FALSE)) {
            ...
            listViewFactory.addRoutedContent(ListViewRoutedContentDto.builder()
                    ...
                    .inlineContent(ListViewHeaderContentDto.builder()
                            .sourceUrl(USER_SERVICE_URL + USER_ID_PARAM + "/summary")
                                    ...
                                    .content(Arrays.asList(
                                            ListViewItemInlineDockContentItemDto.builder()
                                                    ...
                                                    .content(ListViewFormularContentDto.builder()
                                                            .formularUrl(USER_SERVICE_URL + "form")
                                                            .sourceUrl(USER_SERVICE_URL + USER_ID_PARAM)
                                            ...
                                            ListViewItemInlineDockContentItemDto.builder()
                                                    ...
                                                    .content(ListViewListContentDto.builder()
                                                            .listUrl(USER_SERVICE_URL + "appointments/list")
                                                            .sourceUrl(USER_SERVICE_URL + USER_ID_PARAM
                                                                    + "/appointments/query")
                                                            .build())
                                                    .build()))
    ...
    public ListPage findAll(@RequestBody(required = false) final ListQuery predicate) {
        ...
        final ListQueryFactory<User> listQueryFactory =
                new ListQueryFactory<>(this.entityManager, qClazz, qClazz.id, predicate);

        listQueryFactory.addFetchExpr(KokuUserDto.Fields.id, qClazz.id);
        listQueryFactory.addFetchExpr(KokuUserDto.Fields.avatarBase64, qClazz.avatarBase64);
        listQueryFactory.addFetchExpr(KokuUserDto.Fields.firstname, qClazz.firstname);
        listQueryFactory.addFetchExpr(KokuUserDto.Fields.lastname, qClazz.lastname);
        listQueryFactory.addFetchExpr(KokuUserDto.Fields.deleted, qClazz.deleted);
        listQueryFactory.addFetchExpr(
                KokuUserDto.Fields.fullname,
                qClazz.firstname.concat(" ").concat(qClazz.lastname).trim());
        listQueryFactory.addFetchExpr(KokuUserDto.Fields.regionId, qClazz.region.id);
            ...
            throw new KokuBusinessExceptionWithConfirmationMessage(KokuBusinessErrorWithConfirmationMessageDto.builder()
                    ...
                    .button(KokuBusinessExceptionSendToDifferentEndpointButtonDto.builder()
                            ...
                            .endpointUrl(String.format(
                                    "services/customers/customers/appointments/%s?forceUpdate=%s", id, Boolean.TRUE))
                            .build())
